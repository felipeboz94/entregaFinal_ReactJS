...
const ItemDetail = ({children,idPokemon})=>{
    ...
    const callEvolutionChain = (urlBase) =>{
        axios.get(urlBase).then(result =>{
            result && console.log(result.data)//result.data.chain.evolves_to.map((evolucion,index)=>{
                ...
                evolutionChain && console.log(evolutionChain)
            })
        .catch(error=>{
            console.log(error)
        })        
            ...
            <div className='CardDetailsContainer'>
                ...
                <div className = 'descripcion'>
                    <div className = 'descripcionCorta'>
                        ...
                        <p className = 'pokemonName'>Generación: {pokemonDetailsSpecie.generation.name}</p>
                        <p className = 'pokemonName'>Tasa de crecimiento: {pokemonDetailsSpecie.growth_rate.name}</p>
                        <p className = 'pokemonName'>Habitat: {pokemonDetailsSpecie.habitat.name}</p>
                        <p className = 'pokemonName'>Es bebé: {pokemonDetailsSpecie.is_baby ? 'Si ':'No'}</p>
                        <p className = 'pokemonName'>Es legendario: {pokemonDetailsSpecie.is_legendary ? 'Si ':'No'}</p>
                        <p className = 'pokemonName'>Es mítico: {pokemonDetailsSpecie.is_mythical ? 'Si ':'No'}</p>
                        <p className = 'pokemonName'>Forma: {pokemonDetailsSpecie.shape.name}</p>
                    </div>
